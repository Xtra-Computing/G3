...
#include <gunrock/app/sgc/sgc_enactor.cuh>
...
double sgc(gunrock::util::Parameters &parameters, GraphT &graph) {
  typedef typename GraphT::VertexT VertexT;
  typedef gunrock::app::sgc::Problem<GraphT> ProblemT;
  typedef gunrock::app::sgc::Enactor<ProblemT> EnactorT;
